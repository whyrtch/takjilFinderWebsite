...
const Footer: React.FC = () => {
  return (
    <footer className="bg-secondary text-slate-300 py-20">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="md:col-span-2 space-y-6">
            <div className="flex items-center gap-3 text-white">
              ...
              <span className="text-2xl font-bold tracking-tight">TakjilFinder</span>
            </div>
            <p className="max-w-sm text-lg leading-relaxed text-slate-400">
              Connecting the community through generosity and the spirit of Ramadan. Find and share blessings easily with those around you.
            </p>
            <div className="flex items-center gap-4">
              <a href="#" className="w-12 h-12 rounded-full bg-slate-800 flex items-center justify-center hover:bg-primary transition-colors text-white">
        ...
        <div className="pt-12 border-t border-slate-800 text-center text-slate-500 text-sm">
          <p>© 2024 TakjilFinder. Built with love for the Ummah.</p>
        </div>
      </div>
    </footer>
  );
